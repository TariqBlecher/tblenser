...
class LensInstance(object):
    ...
    def sie_string(self):
        ...
        sie_string = "lens sie %f 0 0 %f %f 0 0" % (self.lens_dictionary['v_sigma_kms'],
    ...
    def write_input_file(self):
        ...
        if self.source_dictionary['source_type'] == 'sersic':
            ...
            print self.source_dictionary['source_type']
        else:
    ...
    def calc_mag(self):
        original_image = pf.getdata(self.lens_dictionary['prefix']+'_source.fits')
        lensed_image = pf.getdata(self.lens_dictionary['prefix']+'_image.fits')
